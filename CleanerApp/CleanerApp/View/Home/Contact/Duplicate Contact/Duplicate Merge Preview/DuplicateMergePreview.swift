...
struct DuplicateMergePreview: View {
    ...
    private var titleSection: some View {
        HStack(alignment: .center, spacing: 5) {
            CNText(title: "Preview", color: .txtBlack, font: .system(size: 34, weight: .bold, design: .default), alignment: .trailing)
    ...
    @ViewBuilder private func contactGroupRow(group: ContactGroup) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack(alignment: .center, spacing: 0) {
                CNText(title: "\(group.arrContacts.count) Contacts Merged", color: .txtBlack, font: .system(size: 20, weight: .semibold, design: .default), alignment: .trailing)
            ...
            VStack(alignment: .leading, spacing: 0) {
                VStack(alignment: .leading, spacing: 10) {
                    VStack(alignment: .leading, spacing: 0) {
                        HStack(alignment: .center, spacing: 10) {
                            VStack(alignment: .leading, spacing: 4) {
                                CNText(title: viewModel.getContactName(contactGroup: group), color: .txtBlack, font: .system(size: 17, weight: .medium, design: .default))
                    ...
                    .background {
                        RoundedRectangle(cornerRadius: 26)
                            .fill(Color(hex: "FFDACC"))
                            .stroke(Color(hex: "E97349"), lineWidth: 2)
                    }
                }
                .padding(20)
            }
